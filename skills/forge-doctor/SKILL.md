...
Valid IDs: `claude-opus-4-8[1m]`, `claude-opus-4-7[1m]` (fallback), `claude-sonnet-4-6`, `claude-haiku-4-5-20251001`
Aliases: opus→opus-4-8 (fallback opus-4-7), sonnet→sonnet-4-6, haiku→haiku-4-5-20251001 (expand to full ID on fix)

Defaults: discuss/research/plan phases → opus-4-8 (fallback opus-4-7) | execute/complete → sonnet-4-6 | memory → haiku-4-5-20251001
